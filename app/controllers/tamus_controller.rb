class TamusController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tamu.save
        format.html { redirect_to @tamu, notice: 'Tamu was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tamu.update(tamu_params)
        format.html { redirect_to @tamu, notice: 'Tamu was successfully updated.' }
  ...
  def destroy
    @tamu.destroy
    respond_to do |format|
      format.html { redirect_to tamus_url, notice: 'Tamu was successfully destroyed.' }
